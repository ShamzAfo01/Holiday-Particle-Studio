  ...
  return (
    <div className="relative w-full h-screen bg-[#d70200] overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <Canvas camera={{ position: [0, 2, 18], fov: 40 }} dpr={[1, 2]} shadows>
          <Suspense fallback={null}>
            <ambientLight intensity={0.4} />
            <spotLight position={[10, 20, 10]} angle={0.5} penumbra={1} intensity={1.5} castShadow />
            <pointLight position={[-10, 5, -10]} intensity={0.8} color="#ffaa00" />
            ...
            <fog attach="fog" args={['#d70200', 15, 60]} />
