...
const FestiveText: React.FC = () => {
  ...
  return (
    <group position={[0, -4.4, 4]}>
      ...
      <StyledText text={dateText} position={[-9.5, 2.8, 0]} useNormalWhite={true} scale={0.4} />

      {/* Left: MERRY */}
      <StyledText text="MERRY" position={[-9.5, 0, 0]} />

      {/* Right: CHRISTMAS */}
      <StyledText text="CHRISTMAS" position={[-1.5, 0, 0]} />
    </group>
  );
};
