...
export const GiftModal: React.FC<GiftModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-sm aspect-[4/5] flex items-center justify-center perspective-1000">
          ...
          <div className={`relative w-full h-full transition-transform duration-1000 transform-style-3d ${isFlipped ? 'rotate-y-180' : ''}`}>
            ...
            <div className="absolute inset-0 bg-[#fefefe] border-[2px] border-[#165B33] rounded-2xl shadow-[0_50px_120px_rgba(0,0,0,0.8)] flex flex-col items-center rotate-y-180 backface-hidden p-12 text-center overflow-hidden">
              ...
              <div className="mt-8 mb-4">
                ...
                <h3 className="cursive text-4xl text-[#D42426] leading-tight mb-4">{lore.title}</h3>
                <div className="h-[1px] w-24 bg-[#D42426]/10 mx-auto" />
              </div>
              ...
              <p className="text-slate-500 leading-relaxed italic max-w-xs mb-10 text-sm px-2">
                "{lore.description}"
              </p>
              ...
              <div className="pb-4 w-full border-t border-slate-100 pt-6">
                <p className="cursive text-[#165B33] text-2xl">Happy Holidays,</p>
                <p className="font-black uppercase tracking-[0.2em] text-[9px] text-slate-300 mt-1">From The Magic Snow</p>
              </div>
            </div>
